        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title inner">
                    <h1 class="title">Oтворена врата</h1>
                    <div class="breadcrumbs">
                        <ul class="jus-ct">
                            <li><a href="/" class="f-rubik">Почетна</a></li>
                            <li><p class="breadcrumbs-inner f-rubik">Oтворена врата</p></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <p class="center f-mulish clr-pri-2  wow fadeIn animated" style="text-align: justify;" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                            ...
                            <div class="img float-left mr-5 mt-5 mb-1">
                                <div class="wrap-image ps-re">
                                    ...
                                    <div class="image p-l70"><img src="assets/images/common/4a06cd2871d4e7af731712c115118867-0.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/4a06cd2871d4e7af731712c115118867-1.jpg" alt="Images"></div>
