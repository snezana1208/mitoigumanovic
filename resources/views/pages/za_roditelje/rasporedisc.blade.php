        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title inner">
                    <h1 class="title">Распореди писаних провера за Сечу Реку</h1>
                ...
                <div class="sc-about-2 p-t19">
                    <div class="title-heading">
                        <div class="sub-heading text-center clr-pri-3 f-mulish">
                            ...
                            <span class="inner-sub st-1">Распореди писаних провера за Сечу Реку</span>
                            ...
                            <div class="img float-left mr-5 mt-5 mb-1">
                                <div class="wrap-image ps-re">
                                    ...
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-1.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-2.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-3.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-4.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-5.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-6.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-7.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-8.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Распоред провера Сеча Река 2022-9.jpg" alt="Images"></div>
                            </div>
                        </div>    
@endsection