...
@section('title', 'Педагог саветује')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title inner">
                    <h1 class="title">Педагог саветује</h1>
                    <div class="breadcrumbs">
                        <ul class="jus-ct">
                            <li><a href="/">Почетна</a></li>
                            <li><p class="breadcrumbs-inner f-rubik">Педагог саветује</p></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                @foreach ($posts as $post)
                    ...
                    <div class="sc-event-box active fx wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                        <div class="image">
                            <a href="/admin.pedagog.show/{{$post->id}}"><img src="/storage/post_image/{{$post->image}}" alt=""></a> 
                        </div>
                        <div class="content">
                            <h3><a href="/admin.pedagog.show/{{$post->id}}">{{$post->title}}</a></h3>
                            <ul>
                        ...
                        <a href="/admin.pedagog.show/{{$post->id}}" class="fl-btn st-1">
