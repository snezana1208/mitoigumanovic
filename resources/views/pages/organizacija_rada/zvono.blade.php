        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title inner">
                    <h1 class="title">Кућни ред</h1>
                    <div class="breadcrumbs">
                        <ul class="jus-ct">
                            <li><a href="/" class="f-rubik">Почетна</a></li>
                            <li><p class="breadcrumbs-inner f-rubik">Звоно</p></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="sc-about-2 p-t19">
                    <div class="title-heading">
                        <div class="sub-heading text-center clr-pri-3 f-mulish">
                            ...
                            <span class="inner-sub st-1">Кућни ред и распоред звона</span>
                            ...
                            <div class="img float-left mr-5 mt-5 mb-1">
                                <div class="wrap-image ps-re">
                                    ...
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-1.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-2" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-3.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-4.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-5.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-6.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-7.jpg" alt="Images"></div>
                                    <div class="image p-l70"><img src="assets/images/common/Kućni red školska 2021 22-8.jpg" alt="Images"></div>
                                </div>
                            </div>
                        </div>       
@endsection