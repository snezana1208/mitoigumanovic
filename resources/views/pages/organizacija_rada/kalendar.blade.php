...
@section('title', 'Школски календар')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title inner">
                    <h1 class="title">Школски календар</h1>
                    <div class="breadcrumbs">
                        <ul class="jus-ct">
                            <li><a href="/" class="f-rubik">Почетна</a></li>
                            <li><p class="breadcrumbs-inner f-rubik">Школски календар</p></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="sc-about-2 p-t19">
                    <div class="title-heading">
                        <div class="sub-heading text-center clr-pri-3 f-mulish">
                            ...
                            <span class="inner-sub st-1">Школски календар</span>
                            ...
                            <div class="img float-left mr-5 mt-5 mb-1">
                                <div class="wrap-image ps-re">
                                    ...
                                    <div class="image p-l70"><img src="assets/images/common/Tabelarni-Plan-nastave.jpg" alt="Images"></div>
