...
<section class="tf-section tf-event">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                @foreach ($posts as $post)
                    ...
                    <div class="sc-event-box active fx wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                        <div class="image">
                           <a href="/admin.letopis.show/{{$post->id}}"><img src="/storage/post_image/{{$post->image}}" alt=""></a> 
                        </div>
                        <div class="content">
                            <h3><a href="/admin.letopis.show/{{$post->id}}">{{$post->title}}</a></h3>
                            <ul>
