...
@section('title', 'Ученици генерације')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title inner">
                    <h1 class="title">Ученици генерације</h1>
                    <div class="breadcrumbs">
                        <ul class="jus-ct">
                            <li><a href="/">Почетна</a></li>
                            <li><p class="breadcrumbs-inner f-rubik">Ученици генерације</p></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                @foreach ($posts as $post)
                    ...
                    <div class="sc-event-box active fx wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                        ...
                        <a href="/admin.ucenici_generacija.show/{{$post->id}}" class="fl-btn st-1">
