            ...
            <div class="col-12">
                <div class="title-heading st-2">
                    <div class="sub-heading clr-pri-3 f-mulish">
                        ...
                        <span class="inner-sub st-1">Who We Are</span>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="77" height="30" viewBox="0 0 77 30">
                            <g>
                    ...
                    <h2 class="title clr-pri-2">Discover Now Why People 
                        Come With Kindco</h2>
                </div>
            </div>
            <div class="col-12">
                <div class="fl-discovery">
                    <div class="sc-discovery wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="800ms">
                        <div class="inner-discovery">
                            ...
                            <h5 class="title"><a href="about.html">Study & Game</a></h5>
                    ...
                    <div class="sc-discovery active wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                        <div class="inner-discovery">
                            ...
                            <h5 class="title"><a href="about.html">A to Z Programs</a></h5>
                            <p class="sub f-mulish">Sed ut periciatis unde omis natu voluta</p>
                            <a href="about.html" class="fl-btn st-10">
                                <span class="inner">read more</span>
                            </a>
                    ...
                    <div class="sc-discovery wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1200ms">
                        <div class="inner-discovery">
                            ...
                            <h5 class="title"><a href="about.html">Expert Teacher</a></h5>
                            <p class="sub f-mulish">Sed ut periciatis unde omis natu voluta</p>
                            <a href="about.html" class="fl-btn st-10">
                                <span class="inner">read more</span>
                            </a>
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                <div class="feature-about2">
                    <img src="assets/images/common/sc-aboutus-2.jpg" alt="Image" class="wow fadeInLeft animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-12">
                <div class="sc-about-2">
                    <div class="title-heading">
                        ...
                        <h2 class="title clr-pri-2">Историјат
                        </h2>
                    </div>
                    <div class="inner">
...
<section class="tf-section tf-counter">
    <img src="assets/images/pattern/fun-fact-1.png" alt="Image" class="fun-fact1">
            ...
            <div class="col-xl-6 col-lg-8 col-md-12 col-12">
                <div class="sc-about-1 wow fadeInLeft animated" data-wow-delay="0.3ms" data-wow-duration="1400ms">
                    <div class="title-heading">
                        ...
                        <h2 class="title clr-pri-2">25 Years Of Experience 
                            In Education!
                        </h2>
                    </div>
                    <div class="inner">
                        <p class="wrap f-mulish clr-pri-4">Sit amet consectetur adipiscing eiusmod tempor incididunts ut labore et dolores magna aliqua suspendisse</p>
                        <ul>
                            <li class="st-1 fx"><i class="fas fa-check"></i><p class="clr-pri-2">Best Skills & Resutls</p></li>
                            <li class="st-2 fx"><i class="fas fa-check"></i><p class="clr-pri-2">Drop Our Rates</p></li>
                            <li class="st-3 fx"><i class="fas fa-check"></i><p class="clr-pri-2">Experience Teachers</p></li>
                            <li class="st-4 fx"><i class="fas fa-check"></i><p class="clr-pri-2">Outdoor Activities</p></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="title-heading st-3">
                    ...
                    <h2 class="title clr-pri-2">What Parents Say About Our 
                        <span class="clr-pri-3">Kindco</span> Kindergarten</h2>
                </div>
            </div>
            <div class="col-12">
                <div class="sc-quote">
                    <div class="list-author m-t-62">
                        <ul>
                            <li><img src="assets/images/thumbnails/list-quote-1.jpg" alt="Image"></li>
                            <li><img src="assets/images/thumbnails/list-quote-2.jpg" alt="Image"></li>
                            <li><img src="assets/images/thumbnails/list-quote-3.jpg" alt="Image"></li>
                        ...
                        <div class="themesflat-carousel clearfix" data-margin="30" data-item="1" data-item2="1" data-item3="1" data-item4="1" data-auto="false">
                            <div class="owl-carousel owl-theme none">
                                <div class="item-quote" data-dot="">
                                    ...
                                    <div class="wrap">
                                        <p class="clr-pri-2">“ On the other hand denounce with right eouses 
                                ...
                                <div class="item-quote" data-dot="">
                                    <div class="heading">
                                        <div class="left fx">
                                            <div class="box-avt">
                                                <img src="assets/images/thumbnails/avt-quote4.jpg" alt="Image">
                                            </div>
                                            <ul>
                                                <li><h4 class="name-author clr-pri-2">Bradley Y. Grimes</h4></li>
                                                <li><p class="clr-pri-5 f-mulish">Senior Manager</p></li>
                                ...
                                <div class="item-quote" data-dot="">
                                    <div class="heading">
                                        <div class="left fx">
                                            <div class="box-avt">
                                                <img src="assets/images/thumbnails/avt-quote5.jpg" alt="Image">
                                            </div>
                                            <ul>
                                                <li><h4 class="name-author clr-pri-2">Bradley Y. Grimes</h4></li>
                                                <li><p class="clr-pri-5 f-mulish">Senior Manager</p></li>
                                ...
                                <div class="item-quote" data-dot="">
                                    <div class="heading">
                                        <div class="left fx">
                                            <div class="box-avt">
                                                <img src="assets/images/thumbnails/avt-quote6.jpg" alt="Image">
                                            </div>
                                            <ul>
                                                <li><h4 class="name-author clr-pri-2">Bradley Y. Grimes</h4></li>
                                                <li><p class="clr-pri-5 f-mulish">Senior Manager</p></li>
