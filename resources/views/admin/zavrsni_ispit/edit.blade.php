...
@section('title', 'Измена завршни испит')
...
<div class="col-12 grid-margin stretch-card" id="container">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">Заврчни испит</h3>
        <p class="card-description">
          
        </p>
        <form class="forms-sample" action="/admin.zavrsni_ispit/{{$post->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
